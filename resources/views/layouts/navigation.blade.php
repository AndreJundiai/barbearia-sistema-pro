        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        <form method="POST" action="{{ route('logout') }}" class="inline-flex items-center ps-4">
                            @csrf
            ...
            <!-- Hamburger (Hidden on mobile as we use bottom nav) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                @endif
            @endauth
            <x-responsive-nav-link :href="route('ai-corrector.index')" :active="request()->routeIs('ai-corrector.*')">
                {{ __('AI Corrector') }}
            </x-responsive-nav-link>
            
            @auth
                <form method="POST" action="{{ route('logout') }}" class="px-4 py-2 border-t border-gray-200">
                    @csrf
                    <button type="submit" class="text-sm font-bold text-red-600 uppercase">
                        SAIR DO SISTEMA
                    </button>
                </form>
            @endauth
